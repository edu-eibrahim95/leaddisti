...
use App\EmailQueue;
use App\Lead;
use App\LeadEmployeeBand;
use App\LeadRegion;
use App\LeadSpecialism;
use App\LeadTurnover;
use App\Partner;
...
class LeadsController extends VoyagerBaseController
{
    ...
    public function processData($data){
        ...
        $partners = $partners->where(function($query) use($turnovers, $specialisms, $employee_bands){
            ...
            })->whereHas('employee_bands', function($query) use ($employee_bands) {
    ...
    public function destroy(Request $request, $id)
    {
        ...
        LeadSpecialism::whereIn('lead_id', $ids)->delete();
        LeadTurnover::whereIn('lead_id', $ids)->delete();
        LeadEmployeeBand::whereIn('lead_id', $ids)->delete();
        $data = $res
            ? [
